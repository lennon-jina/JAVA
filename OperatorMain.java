...
public class OperatorMain {
	...
	public static void main(String[] args) {
		...
		// 주의 (연산자의 전, 후에 따라 다름)
		int a, b;
		a = num++; // 후 *여기서 11이 할당됨 근데 표시는 안 됨
		b = ++num; // 전 *그리고 여기서 11 + 1 이 되어서 12가 된 거임
		...
		// 5. 삼항 연산자 (조건 연산자)
		// (a) ? (b) : (c)    a 의 조건식이 true 이면 b 아니면 c
		...
		// 조건이 맞지 않으면 (4자리 이상으로 다시 입력하세요.) 출력
		...
		// 3. 조건식  ex) a ? b : (aa ? bb : cc)
		//             삼항연산자 안에 삼항연산자 들어갈 수 있음.
