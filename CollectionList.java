...
public class CollectionList {
	...
	public static void main(String[] args) {
		/*
		 *  컬렉션 프레임워크는 데이터를 보다 수비게 다룰 수 있도록 재사용 가능한
		 *  컬렉션 클래스르 제공함.
		 *  List, Set, Map
		 *  1. List : 순서대로 객체를 저장하는 구조, 중복된 원소를 허용
		 *            원소에 접근하기 ㅜ이해 인덱스 사용. (ArrayList, LinkedList)
		 *  2. Map : key와 value 쌍으로 이루어진 객체를 저장하는 구조
		 *           key는 중복될 수 없으며 각 키는 하나의 값을 가리김. (HashMap, TreeMap)
		 ...
		 */
		 ...
		 students.remove("동길");                   // 해당값이 있으면 삭제 없으면 아무일도 안 일어남.
		 ...
		 stu.set(0, "지석");
		 System.out.println(students);
		 System.out.println(stu);    // 얕은 복사는 주소를 복사(공유하는)하기 때문에 둘 다 같음
		 ...
		 // 기본 타입 (int, float, boolean...)은 Wrapper class 사용 Integer, Boolean..
